...
- **`src/config.json`** stays the template's. This is a 3x2 tile, not the 2x2 in the phase doc: the lane is about 79K µm² before layout, which would be tight on a 2x2 core (~150K µm²) with four metal layers.

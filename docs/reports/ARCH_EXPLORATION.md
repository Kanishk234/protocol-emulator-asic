...
| WAIT (pin B edge) | Sequence one pin against another pin's real edge | I2C controller (START/STOP after SCL rises; SCL clocks after the START edge) | SWD/JTAG turnarounds, ready/busy handshakes, DShot telemetry turnaround |

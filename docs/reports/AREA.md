...
|---|---|---|---|
| 2026-09-24 | R1 spike: one lane (12 slots, EVAL/EXEC, ALU) + 2 consumer ports, Yosys onto cmos5l typ, no layout | `spikes/r1_lane/run_r1.sh`; `R1_LANE_TIMING.md` §4 | Latch slots: ~67K µm² per lane (lane 36.1K, ALU 5.9K, slots 25.5K = 636 + 64 latch bits + 52 clock-gate latches); 170 lane flops. Flop slots: slots 51.7K. Three lanes with latches ~202K µm² (22 % of the core). EVAL at 20 ns: worst slack +8.2 ns (slow corner) |
